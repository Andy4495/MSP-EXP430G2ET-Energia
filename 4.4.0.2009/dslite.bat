...
set GENERATED_COMMAND=-c user_files/configs/MSP430G2553.ccxml -l user_files/settings/generated.ufsettings -s VerifyAfterProgramLoad=2 -e -f -v "user_files/images/Blink.ino.hex" 
set ADDITIONALS=-n 0
